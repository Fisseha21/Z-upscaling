...
def psnr_loss(example: Mapping[str, tf.Tensor],
  ...
  #y = example['y']
  #logging.info('shape_image', tf.reduce_min(img), tf.reduce_max(img))
  #logging.info('shape_example', tf.reduce_min(y), tf.reduce_max(y))

  #logging.info('shape_example', example['y'].shape)
